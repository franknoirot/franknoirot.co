...
var app = (function () {
    ...
    // (16:2) {#each controls as control, i (control.color+i)}
    function create_each_block(key_1, ctx) {
    	...
    	function input_handler(...args) {
    		return /*input_handler*/ ctx[2](/*control*/ ctx[3], /*each_value*/ ctx[4], /*i*/ ctx[5], ...args);
    	}
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:2) {#each controls as control, i (control.color+i)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 21, 2, 553);
    			attr_dev(section0, "class", "grid svelte-1gya0lc");
    			add_location(section0, file$2, 14, 1, 319);

    			attr_dev(rect, "x", rect_x_value = /*controls*/ ctx[0][0] && /*controls*/ ctx[0][0].value !== undefined
    			? /*controls*/ ctx[0][0].value
    			: 5);

    			attr_dev(rect, "y", rect_y_value = /*controls*/ ctx[0][1] && /*controls*/ ctx[0][1].value !== undefined
    			? /*controls*/ ctx[0][1].value
    			: 2.5);

    			attr_dev(rect, "width", rect_width_value = /*controls*/ ctx[0][2] && /*controls*/ ctx[0][2].value !== undefined
    			? /*controls*/ ctx[0][2].value
    			: 10);

    			attr_dev(rect, "height", rect_height_value = /*controls*/ ctx[0][3] && /*controls*/ ctx[0][3].value !== undefined
    			? /*controls*/ ctx[0][3].value
    			: 5);

    			attr_dev(rect, "fill", rect_fill_value = `hsl(${/*controls*/ ctx[0][4] && /*controls*/ ctx[0][4].value !== undefined
			? /*controls*/ ctx[0][4].value
			: 190}deg, 60%, 60%)`);

    			add_location(rect, file$2, 25, 3, 731);
    			attr_dev(svg, "viewBox", "0 0 20 10");
    			set_style(svg, "max-width", "720px");
    			set_style(svg, "border", "solid 4px");
    			add_location(svg, file$2, 24, 2, 656);
    			add_location(section1, file$2, 23, 1, 643);
    			attr_dev(main, "class", "svelte-1gya0lc");
    			add_location(main, file$2, 13, 0, 310);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*controls*/ 1 && rect_x_value !== (rect_x_value = /*controls*/ ctx[0][0] && /*controls*/ ctx[0][0].value !== undefined
    			? /*controls*/ ctx[0][0].value
    			: 5)) {
    				attr_dev(rect, "x", rect_x_value);
    			}

    			if (!current || dirty & /*controls*/ 1 && rect_y_value !== (rect_y_value = /*controls*/ ctx[0][1] && /*controls*/ ctx[0][1].value !== undefined
    			? /*controls*/ ctx[0][1].value
    			: 2.5)) {
    				attr_dev(rect, "y", rect_y_value);
    			}

    			if (!current || dirty & /*controls*/ 1 && rect_width_value !== (rect_width_value = /*controls*/ ctx[0][2] && /*controls*/ ctx[0][2].value !== undefined
    			? /*controls*/ ctx[0][2].value
    			: 10)) {
    				attr_dev(rect, "width", rect_width_value);
    			}

    			if (!current || dirty & /*controls*/ 1 && rect_height_value !== (rect_height_value = /*controls*/ ctx[0][3] && /*controls*/ ctx[0][3].value !== undefined
    			? /*controls*/ ctx[0][3].value
    			: 5)) {
    				attr_dev(rect, "height", rect_height_value);
    			}

    			if (!current || dirty & /*controls*/ 1 && rect_fill_value !== (rect_fill_value = `hsl(${/*controls*/ ctx[0][4] && /*controls*/ ctx[0][4].value !== undefined
			? /*controls*/ ctx[0][4].value
			: 190}deg, 60%, 60%)`)) {
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ DialMIDI, controls, addControl });
    	...
    	return [controls, addControl, input_handler];
    }
