...
var app = (function () {
    ...
    // (24:2) {#each controls as control, i (control.color+i)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(24:2) {#each controls as control, i (control.color+i)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 29, 2, 733);
    			attr_dev(section0, "class", "grid svelte-1gya0lc");
    			add_location(section0, file$2, 22, 1, 495);
    			...
    			add_location(rect, file$2, 33, 3, 911);
    			attr_dev(svg, "viewBox", "0 0 20 10");
    			set_style(svg, "max-width", "720px");
    			set_style(svg, "border", "solid 4px");
    			add_location(svg, file$2, 32, 2, 836);
    			add_location(section1, file$2, 31, 1, 823);
    			attr_dev(main, "class", "svelte-1gya0lc");
    			add_location(main, file$2, 21, 0, 486);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
