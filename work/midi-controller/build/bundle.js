...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(circle5, file, 12, 4, 523);
    ...
    // (15:1) {#each controls as control, i (control.color+i)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*controls*/ 1) dialmidi_changes.id = /*i*/ ctx[4];
    			if (dirty & /*controls*/ 1) dialmidi_changes.color = /*control*/ ctx[2].color;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(15:1) {#each controls as control, i (control.color+i)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const get_key = ctx => /*control*/ ctx[2].color + /*i*/ ctx[4];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "add-midi svelte-fx83wq");
    			add_location(button, file$2, 17, 1, 412);
    			attr_dev(main, "class", "svelte-fx83wq");
    			add_location(main, file$2, 13, 0, 297);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
